...
public class SGTextView2 extends TextView {
    ...
    public SGTextView2(Context context) {
        this(context, null);
    }

    public SGTextView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mStorkWidth = ta.getDimension(R.styleable.SGTextView_sgText_storkWidth, DimensUtils.dip2px(context, 5));
    ...
    public void setStyle(String strokeColor, String startColor,
        ...
        setStyle(Color.parseColor(strokeColor), Color.parseColor(startColor), Color.parseColor(endColor),
                DimensUtils.dip2px(getContext(), strokewidthDp), DimensUtils.dip2px(getContext(),
                        gradientHeighDp));
    }
