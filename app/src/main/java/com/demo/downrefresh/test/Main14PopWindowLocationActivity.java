 ...
 */
public class Main14PopWindowLocationActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button02:
                ...
                //                mPopupWindow.showAsDropDown(mTv, dip2px(50), 0);//设置x轴偏移量为50dip
                //                mPopupWindow.showAsDropDown(mTv, (mTv.getWidth() - dip2px(120)) / 2, 0);//设置x轴偏移量：注意单位为px
    ...
    private void initPopupWindow(int type) {
        ...
        //以下方式是为了在popupWindow还没有弹出显示之前就测量获取其宽高（单位是px相熟）~只能UNSPECIFIED模式下
