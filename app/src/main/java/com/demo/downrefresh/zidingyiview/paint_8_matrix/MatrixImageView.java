...
public class MatrixImageView extends ImageView {
    ...
    private void init() {
        ...
        DisplayMetrics screenSize = ScreenSizeUtils.getScreenSize(getContext());
        ...
        bitmap = Bitmap.createScaledBitmap(bitmap, screenSize.widthPixels, screenSize.heightPixels, true);
