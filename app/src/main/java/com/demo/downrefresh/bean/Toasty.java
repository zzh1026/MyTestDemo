...
public class Toasty {
    ...
    public static @CheckResult Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, es.dmoral.toasty.R.drawable.ic_error_outline_white_48dp),
    ...
    public static @CheckResult Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, es.dmoral.toasty.R.drawable.ic_info_outline_white_48dp),
    ...
    public static @CheckResult Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, es.dmoral.toasty.R.drawable.ic_check_white_48dp),
    ...
    public static @CheckResult Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, es.dmoral.toasty.R.drawable.ic_clear_white_48dp),
    ...
    public static @CheckResult Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        final ImageView toastIcon = (ImageView) toastLayout.findViewById(es.dmoral.toasty.R.id.toast_icon);
        final TextView toastTextView = (TextView) toastLayout.findViewById(es.dmoral.toasty.R.id.toast_text);
